...
The Nova Scotia government made puzzling and frustrating news when they decided to lockdown for the third time. The initial stay-at-home order was unprecedentedly made under caution that the virus' infection fatality rate was 2%. It might have been a prudent move at the time with so much unknown, except now politicians have the luxury be acting on the knowledge and lessons learned from 14-months of emiprical data. The decision for Rankin and Strang to ignore the observational and experimental data to return a destructive policy made only made in brief moment of global tumultuous uncertainty shows cowardice that should be met with public contempt.

Despite the hymns of "trust the science" being harmonized over lockdown edicts, and the media lauding them as a saving grace (geez, I wonder why they would want us to stay home all day?), the science of lockdowns never existed and their unintended consequences poorly considered. The mounting evidence since March 2020 shows at best they only temporarily contained the spread of COVID-19 while generating a host of new problems. Take the following chart that splits the relative number of COVID deaths in European countries during the first and second waves. The asymmetry of the chart is striking and the media headlines praising the success of first-wave lockdowns premature and embarrassing. These lockdowns didn't prevent these deaths, only delayed them at a much greater societal expense that will linger for months/years beyond these 'temporary' dates. 
